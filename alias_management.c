...
/**
 * print_alias - Prints an alias or a list of all aliases.
...
/**
 * get_alias - Retrieves the value of an alias
 * @data: struct for the program's data
 * @name: name of the requested alias.
 * Return: The alias name as an argument and returns its value if found, or null otherwise.
 */
 ...
 * @alias_string: alias string to be seted in the form (name='value')
 * @data: struct for the program's data
 * Return: zero if sucess, or other number if its declared in the arguments
 */
